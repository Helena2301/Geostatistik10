...
idw_rmse <- rmse(x = LOOCV$var1.pred,
                 y = LOOCV$observed)                     
```
...
lr_fvariomodel <- fit.variogram(variomodel,
                                model = m,
                                fit.method = 7)
...
ok_variogram <- variogram(Ca ~ EAST + NORTH,
                           data = ljz,
                           alpha = c(0, 45, 90, 135),
                           cutoff = 4400,
                           width = 150)
